				...
				function (require, module, exports) {
					...
					Cursor.prototype.project = function (candidates) {
						...
						candidates.forEach(function (candidate) {
							var toPush =
								action === 1
									? _.pick(candidate, keys)
									: _.omit(candidate, keys);
							if (keepId) {
			...
			11: [
				function (require, module, exports) {
					...
					Persistence.prototype.persistCachedDatabase = function (cb) {
						...
						storage.crashSafeWriteFile(this.filename, toPersist, function (
							err
						) {
							if (err) {
								return callback(err);
					...
					Persistence.prototype.persistNewState = function (newDocs, cb) {
						...
						storage.appendFile(self.filename, toPersist, 'utf8', function (
							err
						) {
							return callback(err);
						});
									...
									Persistence.ensureDirectoryExists(
										...
										function (err) {
											storage.ensureDatafileIntegrity(self.filename, function (
												...
												storage.readFile(self.filename, 'utf8', function (
													err,
													rawData
												) {
													if (err) {
													...
													Object.keys(treatedData.indexes).forEach(function (
														key
													) {
											...
											LocalForage.prototype.defineDriver = function defineDriver(
												...
												var promise = new Promise(function (resolve, reject) {
													try {
														...
														var customDriverMethods = LibraryMethods.concat(
															'_initStorage'
														);
														for (
															var i = 0;
